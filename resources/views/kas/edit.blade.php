      ...
      <div class="row">
        <div class="col-md-6">
          <div class="mb-3">
            ...
            <input type="date" class="form-control" id="tanggal" name="tanggal" value="{{ $kas->tanggal->format('Y-m-d') }}" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="mb-3">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="sumber_kas" name="sumber_kas" value="{{ $kas->sumber_kas }}" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="mb-3">
            <label for="kategori" class="form-label">Kategori</label>
            <input type="text" class="form-control" id="kategori" name="kategori" value="{{ $kas->kategori }}">
          </div>
        </div>
      </div>
      <div class="row">
