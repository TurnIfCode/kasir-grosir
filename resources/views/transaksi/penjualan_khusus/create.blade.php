        ...
        <div class="card-body p-1 p-md-3">
            ...
            <form id="detailContainer" class="mt-2">
                ...
                <div class="row align-items-center g-2 py-2 border-bottom detail-row" data-row="0">
                    ...
                    <div class="col-1">
                        <input type="number" class="form-control harga-jual-input" name="detail[0][harga_jual]" id="harga_jual[0]" data-id="0">
                    </div>
...
$(document).ready(function () {
    ...
    $(document).on('click', '#btnSimpanCetak', function () {
        ...
        // ================= AJAX =================
        $.ajax({
            url: "{{ route('penjualan_khusus.store') }}",
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
    ...
    $(document).on("keyup", ".harga-jual-input", function() {
        var dataId = $(this).attr('data-id');
        let barangId = $("#barang_id\\[" + dataId + "\\]").val();
        let satuanId = $("#satuan_id\\[" + dataId + "\\]").val();
        let tipeHarga = $("#tipe_harga\\[" + dataId + "\\]").val();
        ...
        var qty = $("#qty\\[" + dataId + "\\]").val();
        console.log("INI HARGA JUAL INPUT", barangId, satuanId, tipeHarga, hargaJual, qty);
