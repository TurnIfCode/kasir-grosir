      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group mb-3">
            ...
            <input type="text" name="kode_supplier" id="kode_supplier" class="form-control" value="{{ old('kode_supplier', $supplier->kode_supplier) }}" required>
            @error('kode_supplier')
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group mb-3">
            ...
            <input type="text" name="kontak_person" id="kontak_person" class="form-control" value="{{ old('kontak_person', $supplier->kontak_person) }}">
            @error('kontak_person')
              <div class="text-danger">{{ $message }}</div>
            @enderror
          </div>
        ...
        <div class="col-md-6">
          <div class="form-group mb-3">
            ...
            <input type="text" name="telepon" id="telepon" class="form-control" value="{{ old('telepon', $supplier->telepon) }}">
            @error('telepon')
              <div class="text-danger">{{ $message }}</div>
            @enderror
          </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group mb-3">
            ...
            <input type="text" name="kota" id="kota" class="form-control" value="{{ old('kota', $supplier->kota) }}">
            @error('kota')
              <div class="text-danger">{{ $message }}</div>
            @enderror
          </div>
        ...
        <div class="col-md-6">
          <div class="form-group mb-3">
            ...
            <input type="text" name="provinsi" id="provinsi" class="form-control" value="{{ old('provinsi', $supplier->provinsi) }}">
            @error('provinsi')
              <div class="text-danger">{{ $message }}</div>
            @enderror
          </div>
